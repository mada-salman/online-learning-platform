...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (quizContainer) {
        ...
        options.forEach(option => {
            option.addEventListener('change', function() {
                if (this.value === 'Protect data') {
                    alert('Correct! The primary goal of Cyber Security is to protect data and systems from unauthorized access and threats.');
                } else {
    ...
    if (startChallengeBtn) {
        startChallengeBtn.addEventListener('click', function() {
            alert('Starting Security Implementation Challenge...');
    ...
    if (startProjectBtn) {
        startProjectBtn.addEventListener('click', function() {
            alert('Starting Security Audit Project...');
